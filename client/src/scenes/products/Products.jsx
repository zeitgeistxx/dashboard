...
import { useGetProductsQuery } from "../../state/apiCalls"
            ...
            <CardActions>
                ...
                >
                    <CardContent>
                        ...
                        <Typography>Yearly Sales This Year: {stat[0].yearlySalesTotal
                        }</Typography>
                        <Typography>Yearly Units Sold This Year: {stat[0].yearlyTotalSoldUnits
                        }</Typography>
                    </CardContent>
                </Collapse>
            </CardActions>
